...
`;
  ...
  declare namespace wx {
    ...
    export function uploadFile(param: WXNS.IUploadFileParam): WXNS.IUploadFileTask
    export function downloadFile(param: WXNS.IDownloadFileParam): WXNS.IDownloadFileTask
  ...
  */
  ...
  str += `
  declare var require: {
    (module: "wx-server-sdk"): typeof ServerSDK.cloud
    (module: string): any
  }
  `
...
declare namespace ServerSDK {
  ...
  interface ICloudService {
    ...
    getAPIs: () => Record<string, IAPIFunction<any, any>>,
  }
  ...
  export const cloud: {
    callFunction(param: ICloud.CallFunctionParam): Promise<ICloud.CallFunctionResult>
    uploadFile(param: ICloud.UploadFileParam): Promise<ICloud.UploadFileResult>
    downloadFile(param: ICloud.DownloadFileParam): Promise<ICloud.DownloadFileResult>
    deleteFile(param: ICloud.DeleteFileParam): Promise<ICloud.DeleteFileResult>
    getTempFileURL(param: ICloud.GetTempFileURLParam): Promise<ICloud.GetTempFileURLResult>
  } & IICloudAPI & {
    database: (config?: ICloudConfig) => DB.Database
  }
  ...
  namespace DB {
    ...
    export class CollectionReference extends Query {
      ...
      add(options: IAddDocumentOptions): Promise<IAddResult>
    ...
    export class DocumentReference {
      ...
      field(object: object): DocumentReference

      get(options?: IGetDocumentOptions): Promise<IQuerySingleResult>

      set(options?: ISetSingleDocumentOptions): Promise<ISetResult>

      update(options?: IUpdateSingleDocumentOptions): Promise<IUpdateResult>

      remove(options?: IRemoveSingleDocumentOptions): Promise<IRemoveResult>
    ...
    export class Query {
      ...
      // update(options?: IUpdateDocumentOptions): Promise<IUpdateResult>

      // remove(options?: IRemoveDocumentOptions): Promise<IRemoveResult>

      count(options?: ICountDocumentOptions): Promise<ICountResult>
