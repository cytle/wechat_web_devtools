        ...
        if (document.readyState == 'complete') {
          ...
          <body style="overflow:hidden">
            ${a}
              ...
              </html>`}):n?await b.getJSFile(j,g.replace(/^\//,'')):void 0},getUsrFileResponse:async function(a){a=a.replace(/\/$/,'');let b=g.getUsrFileRealPath(a);return j.readFileSync(b,null)}}}(require('lazyload'),require);