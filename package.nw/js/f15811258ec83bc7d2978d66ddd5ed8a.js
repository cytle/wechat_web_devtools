'use strict';var _extends=Object.assign||function(a){for(var b,c=1;c<arguments.length;c++)for(var d in b=arguments[c],b)Object.prototype.hasOwnProperty.call(b,d)&&(a[d]=b[d]);return a};!function(require,directRequire){function a(a,b){if(a&&(a.contextMenus.removeAll(),b&&Array.isArray(b)))for(const c of b)c&&a.contextMenus.create(c)}function b(a,b,c){var d=Math.round;if(a&&b){a.contextMenus.removeAll();const e=a.getBoundingClientRect().left+b.left,f=a.getBoundingClientRect().top+b.top,g=new nw.Menu,h={};for(const a of b.items){(!a.id||h[a.id])&&(a.id=Math.random()+'');const b=new nw.MenuItem(_extends({},a,{label:a.title||a.label,id:void 0,click:()=>c({menuItemId:a.id})}));h[a.id]=b}const i=[];for(const a of b.items){if(!a.parentId||!h[a.parentId]){i.push(h[a.id]);continue}const b=h[a.parentId];b.submenu||(b.submenu=new nw.Menu),b.submenu.append(h[a.id])}for(const a of i)g.append(a);g.popup(d(e),d(f))}}var c=c||{},d=new WeakMap;c.enable=function(c,e){const f=function(a){e&&e.onShowContextMenu&&e.onShowContextMenu(a)},g=function(b){e&&e.onClickContextMenu&&e.onClickContextMenu(b);const d=(b&&b.menuItemId||'').replace(/\'/g,'\\\'');c.executeScript({code:`;(function() {
