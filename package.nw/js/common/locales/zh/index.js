module.exports = {
  ...
  ACCOUNT_BOX_TITLE: '选择你要登录的测试号，用于多账号调试',
  ACCOUNT_BOX_TEST_ACCOUNT: '测试帐号',
  ACCOUNT_BOX_LOGIN: '登录',
  ACCOUNT_BOX_ADD_TITLE: '添加测试号',
  ACCOUNT_BOX_ADD_MSG: '请使用微信搜二维码登录',
  ACCOUNT_BOX_ADD_ERR_MSG: '该账号已经登录，请使用其他微信号',
  ...
  DEVELOPMENT_ENVIRONMENT: '生产环境',
  PRODUCTION_ENVIRONMENT: '开发环境',
  DEVELOPMENT_ENVIRONMENT_INFORMATION: '生产环境信息',
  PRODUCTION_ENVIRONMENT_INFORMATION: '开发环境信息',
  ...
  AUTO_COMPRESSED_WHEN_UPLOADING: '上传代码时自动压缩',
