module.exports = {
  ...
  GENERAL: '通用',
  SETTING_LAUNCH_OPTION: '启动设置：',
  SETTING_OPEN_LAST_MODIFIED_PROJECT: '打开最后一次修改项目',

  SETTING_THEME: '主题：',
  SETTING_DEVTOOLS_THEME: '调试器主题:',
  SETTING_THEME_DARK: '深色',
  SETTING_THEME_WHITE: '浅色',
  SETTING_MINIMAP: '代码缩略图',
  SETTING_FONT_FAMILY: '字体：',
  SETTING_FONT_SIZE: '字号：',
  SETTING_LINE_SPACING: '行距',
  SETTING_SIMULATOR_ALIGNMENT: '模拟器位置:',
  SETTING_SIMULATOR_ALIGNMENT_LEFT: '左边',
  SETTING_SIMULATOR_ALIGNMENT_RIGHT: '右边',
  ...
  SETTING_SECURITY_SERVICE_PORT: '服务端口：',
  SETTING_SECURITY_ON: '开启',
  SETTING_SECURITY_OFF: '关闭',
  SETTING_SECURITY_SERVICE_PORT_ON_DESC: '工具的服务端口已开启。命令行和 HTTP 均可调用工具。',
  SETTING_SECURITY_SERVICE_PORT_OFF_DESC: '工具的服务端口已关闭。命令行和 HTTP 都无法调用工具。',
  ...
  CREATE_PROJECT_TIP_DIRECTORY_EXIST: '该目录下的项目（%s）已在工具中创建，可[直接打开]@click',
  CREATE_PROJECT_TIP_HASH_EXIST: '已存在相同 AppID、项目名称和项目路径和项目，请修改任一项并重试',
  CREATE_PROJECT_TIP_MUST_USE_EMPTY_FOLDER: '请选择空目录',
  CREATE_PROJECT_TIP_MUST_CHOOSE_FOLDER: '创建临时目录失败，请选择一个目录',
  CREATE_PROJECT_TIP_MUST_USE_VALID_MINI_APP_FOLDER: '请选择空目录或含 %s 的目录',
  CREATE_PROJECT_TIP_MUST_USE_VALID_MINI_APP_FOLDER_TO_IMPORT: '请选择含 %s 的目录',
  ...
  RESOURCE_LOADING_IMAGE: '不允许在项目中直接引用 loadingImageInfo.path: %s',
  ...
  UNKNOWN_TIME: '未知时间',
  UNKNOWN_USER: '未知用户',
  MINI_PROGRAM_DEV_ASSISTANT: '小程序助手',
  ...
  CONSOLE_PREPROCESS_UPLOAD_START: '开始执行自定义上传前预处理命令...',
  CONSOLE_PREPROCESS_UPLOAD_ERROR: '执行自定义上传前预处理命令失败!',
  CONSOLE_PREPROCESS_UPLOAD_RUNNING: '正在执行自定义上传前命令...',
  CONSOLE_PREPROCESS_UPLOAD_SUCCESS: '自定义上传前命令执行完毕',
  ...
  MINI_GAME_PROJECT: '小游戏项目',
  MINI_GAME_PROJECT_DEBUG: '编辑、调试小游戏',
  OFFICIAL_WEB_PROJECT: '公众号网页项目',
  OFFICIAL_WEB: '公众号网页',
  OFFICIAL_WEB_DEBUG: '调试公众号网页',
  MINI_PROGRAM_DEV_DOC: '小程序开发文档',
  MINI_PROGRAM_DEV_BBS: '小程序开发社区',
  MINI_CODE_DETAIL: '代码片段是一种可分享的小项目',
  MINI_CODE_MANAGE: '管理代码片段',
  MINI_CODE_NEW: '新建',
  MINI_CODE_IMPORT: '导入',
  PROJECT_MANAGE: '管理项目',
  PROJECT_NEW: '新增',
  ...
  MINI_CODE_CREATE: '创建代码片段',
  MINI_CODE_NAME: '代码片段名称',
  MINI_CODE_DIRECTORY: '代码片段目录',
  MINI_CODE_DESCRIPTION: '代码片段描述',
  MINI_CODE_IMPORT_LONG: '导入代码片段',
  MINI_CODE_IMPORT_DETAIL: '填写代码片段链接即可导入代码片段',
  MINI_CODE_DEFAULTS_TO_TEMP_DIRECTORY: '若不填写则默认在用户目录下创建临时目录存放',
  USE_TEST_ACCOUNT: '使用测试号：',
  SHARER_FILL_APPID: '选填，分享者建议填入 AppID',
  MINI_CODE_APPID_PLACEHOLDER: '选填，部分接口和功能需要 AppID 才能使用',
  ...
  UPLOAD_SIZE_IN_BACKEND: '编译后代码包大小',
  ...
  MINICODE_COMPATIBILITY_NOTICE: '从 1.02.1812180 开始代码片段格式更换，旧版本 IDE 将无法导入该版本及之后的 IDE 分享的代码片段',
  GENERATING: '生成中',
  ...
  MINI_PROGRAM_NO_RESPONSE_FOR_A_LONG_TIME: '小程序长时间没有响应，请确认业务逻辑中是否有复杂运算、死循环，或者在其他的项目窗口的调试器中设置了断点',
  ...
  INFO_DISPLAY_API_NOTICE: '%s API 提示',
  ...
  NOT_FOUND_NODE_MODULES: '没有找到可以构建的 NPM 包。',
  ...
  TCB_STAGE_WILL_UPLOAD_FUNCTION: '上传函数代码',
  ...
  TCB_UPLOAD_FUNCTION: '上传云函数 %s',
  TCB_DOWNLOAD_FUNCTION: '下载云函数 %s',
  TCB_DOWNLOAD_ALL_FUNCTION: '下载全部云函数',
  TCB_GET_FUNC_LIST: '同步云函数列表',
  TCB_GET_ENV_LIST: '同步云环境列表',
  TCB_SET_CURRENT_ENV: '设置云环境',
  TCB_UPLOAD_TRIGGERS: '上传云函数 %s 的触发器',
  TCB_DELETE_TRIGGERS: '删除云函数 %s 的触发器',
  TCB_LOCAL_ERROR_CONFIG_FILE_NOT_FOUND: '未找到云函数配置文件 config.json',
  TCB_LOCAL_ERROR_CONFIG_FILE_PARSE_FAIL: '解析 config.json 失败，请确认文件是标准 JSON 格式',
  TCB_LOCAL_ERROR_CONFIG_FILE_LACK_TRIGGERS: '请确认 config.json 中包含合法的 triggers 字段',
  TCB_LOCAL_ERROR_CONFIG_FILE_TRIGGERS_SPEC_ITEM_NOT_OBJECT: 'triggers[%s] 定义必须是合法对象',
  TCB_LOCAL_ERROR_CONFIG_FILE_TRIGGERS_SPEC_ITEM_LACK_FIELD: 'triggers[%s] 缺少必填参数 %s',
  TCB_ERROR_UPDATE_OPENAPI_PERMISSION: '更新云函数 %s 的云调用权限失败',

  SCF_LOCAL_DEBUG: '云函数本地调试',
  SCF_CALLING_LOCAL: '小程序对本地云函数 \'%s\' 发起了调用',
  SCF_CALL_LOCAL_SUCCESS: '调用本地云函数 \'%s\' 成功',
  SCF_CALL_LOCAL_FAIL: '调用本地云函数 \'%s\' 返回错误',
  SCF_CALLING_CLOUD: '小程序对云端云函数 \'%s\' 发起了调用',

  SIMULATOR_ACTION: '模拟操作',
  NEED_PERMISSION_STATEMENT: '%s 需要在 app.json 中声明 permission 字段',
  ASK_FOR_LOCATION_PERMISSION: '%s 需要获取你的地理位置',
  MESSAGE_TOKEN: '通讯票据',
  MESSAGE_PORT: '通讯端口',

  NOTICE_TASK_COMPLETE: '%s 项任务完成',
  NOTICE_TASK_FAIL: '%s 项任务失败',
  ...
  COMMON_HOURS_AGO: '%s 小时前',
  COMMON_DAYS_AGO: '%s 天前',
  ...
  BLOCK: '阻止',
  VERSION_UPDATE_DONE: '版本更新成功，请重新启动',
  VERSION_UPDATE_FAIL: '版本更新失败，请手动下载版本进行安装',
  VERSION_FALLBACK: '版本回退 (%s)',
  VERSION_FALLBACK_DONE: '版本回退成功，请重新启动',
  VERSION_FALLBACK_FAIL: '版本更新失败，请手动下载版本进行安装',
}
