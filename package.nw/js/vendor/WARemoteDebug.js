...
function () {
  ...
  (0, _createClass2.default)(Debuggee, [{
        ...
        mutation.observer(document, function (mutations) {
          mutations.forEach(function (record) {
            if (record.type === 'attributes') {
              _this5.attributesMutation(record);
            } else if (record.type === 'childList') {
              _this5.childListMutation(record);
            }
          });
        });
      }
    ...
    value: function requestChildNodes(commandParams) {
      ...
      setTimeout(function () {
        var _this6$_requestChildN = _this6._requestChildNodes(nodeId, depth),
            children = _this6$_requestChildN.children;

        _this6.event('DOM.setChildNodes', {
          parentId: nodeId,
          nodes: children
        });
      });
...
/***/ })
/******/ ]);
var WARemoteDebugVersion='2019.1.15 20:40';